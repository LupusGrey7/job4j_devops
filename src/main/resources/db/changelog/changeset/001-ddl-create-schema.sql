...
--changeset petrarsentev:drop-users runAlways:true context:dev,test
...
--changeset petrarsentev:create-hibernate-sequence
...
--changeset petrarsentev:create-users-table
...
--changeset petrarsentev:create-roles-table
